...
#define STRING_CONFIG_H_AUTHOR "Paul Labedan" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,400,94.5}  // default steps per unit
#define DEFAULT_MAX_FEEDRATE          {500, 500, 2, 40}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {3500,3500,100,2500}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
